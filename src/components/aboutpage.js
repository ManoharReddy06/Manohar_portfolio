        ...
        <div className="aboutDiv" id="about">
            ...
            <div className="aboutBox">
                ...
                <motion.div className="aboutHead" initial={{ y: 50, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: "linear" }}>
                    <p>Hey, I'm Manohar Reddy, frontend and full-stack developer.</p>
                </motion.div>
                ...
                <motion.div className="skillsDiv" initial={{ y: 50, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: "linear" }}>
                    ...
                    <div className="skillsImg">
                        ...
                        <div className="skillPic">
                            <motion.img whileHover={{ scale: 1.1 }} transition={{ duration: 0.3 }} src={Mysql} alt="Mysql" style={{ padding: 0, objectFit: 'cover' }} />
                        </div>
                        <div className="skillPic">
                            <motion.img whileHover={{ scale: 1.1 }} transition={{ duration: 0.3 }} src={Java} alt="Java" />
                        </div>
                        <div className="skillPic">
                            <motion.img whileHover={{ scale: 1.1 }} transition={{ duration: 0.3 }} src={Html} alt="Html" />
                        </div>
                        <div className="skillPic">
                            <motion.img whileHover={{ scale: 1.1 }} transition={{ duration: 0.3 }} src={Js} alt="Js" style={{ padding: 0, objectFit: 'cover' }} />
                        </div>
                    </div>
                </motion.div>
            </div>
