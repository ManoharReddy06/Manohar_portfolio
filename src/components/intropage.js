      ...
      <div className="homeIntro">
        <motion.div className="homeContent" initial={{ x: -100, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: "linear" }}>
          ...
          <div className="helpingText">
            <p>Hi, I'm Anreddy Manohar Reddy a full-stack developer. I like to make ideas into reality with the power of web technologies.</p>
          </div>
          <div className="resumeDiv">
            <div className="resume">
              ...
              <div className="resumeLink">
                <a href="https://drive.google.com/file/d/17EzYxTicpPcebAFatuFg4yQSkoK6SwxD/view?usp=sharing" target="_blank">MyResume</a>
              </div>
            </div>
          </div>
